...
class SymbolTable
{
    ...
    SymbolTable( int size, HashFunctionType hashType)
    ...
    void EnterScope(int size, HashFunctionType hashType)

    {

        currentScopeId++;

        ScopeTable *newScope = new ScopeTable(size,  currentScopeId, hashType,currentScope);
